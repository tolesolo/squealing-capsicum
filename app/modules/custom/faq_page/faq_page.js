  ...
  var content = {};
	content['my_collapsibleset'] = {
	  ...
	  items: [
	    ...
	    { header: 'Gimana cara membatalkan order?', content: '<p>Hubungi call center kami. Klik nomor ini <a onclick="javascript:window.open(\'tel:+6281234560736\', \'_system\', \'location=yes\');">08-123456-OJEG(0736)</a>.</p>', 
	    	attributes: {
	    		'data-collapsed-icon': 'arrow-r',
	    		'data-expanded-icon': 'arrow-d' 
	    	} 
	    },
	    { header: 'Driver Get Tranz mengganggu saya', content: '<p>Hubungi call center kami. Klik nomor ini <a onclick="javascript:window.open(\'tel:+6281234560736\', \'_system\', \'location=yes\');">08-123456-OJEG(0736)</a>. Atau masukan keluhan di halaman keluhan, kami akan memberikan surat peringatan, jika perlu kami akan bawa ke pihak berwajib.</p>', 
	    	attributes: {
	    		'data-collapsed-icon': 'arrow-r',
	    		'data-expanded-icon': 'arrow-d' 
	    	} 
