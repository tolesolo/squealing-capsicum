  ...
  try {
    ...
    content.isi = {
      ...
      t('Prasyarat:') + '</br><ol>' +
		...
		'<li>Setelah anda melakukan transfer, silahkan memberikan kami konfirmasi untuk mendapatkan respon yang cepat melalui call center 08-1234-805-101 atau sms center kami di 085-234-805-101</li>' +
		'</ol>' + 
      t('Bagaimana cara menambah saldo GT Wallet:') + '</br><ol>' +
		'<li>Masuk ke http://www.gettranz.co.id/gtwallet/top-up (harus login terlebih dahulu)</li>' +
    ...
    content.driver_kami = {
      ...
      path: 'http://www.gettranz.co.id/gtwallet/top-up',
